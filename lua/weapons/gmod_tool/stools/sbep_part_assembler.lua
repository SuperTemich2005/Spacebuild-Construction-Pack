...
if CLIENT then
	CreateClientConVar("sbep_part_assembler_nocollide", 1, true, true)
	CreateClientConVar("sbep_part_assembler_weld", 1, true, true)
	...
	language.Add( "tool.sbep_part_assembler.0"	  , "(1) Left-click an attachment point. Right-click to show/hide attachment points. Reload to hide all attachment points. Shift + F to toggle between Part Spawner and Part Assembler Tool." )
